...
var _message = _interopDefault(require("antd/lib/message"));
...
var _Popconfirm = _interopDefault(require("antd/lib/popconfirm"));
...
var _Switch = _interopDefault(require("antd/lib/switch"));
...
var _Space = _interopDefault(require("antd/lib/space"));
var _Typography = _interopDefault(require("antd/lib/typography"));
...
function useStoreState(config, extraFn, everyFn) {
  ...
  var _useState = React.useState(store.getData()),
    state = _useState[0],
...
var contextMenuState = {
  ...
  menu: null,
  parent: null,
  contextMenu: /*#__PURE__*/ React__default.createElement(ContextMenu, null),
...
function unmountContextMenu() {
  ...
  if (contextMenuState.menu && contextMenuState.parent) {
    ReactDOM.unmountComponentAtNode(contextMenuState.parent);
    ...
    function () {
      if (
        ...
        return React__default.createElement(
          ...
          React__default.createElement(icons.ReloadOutlined, {
            style: {
              color: "#2196f3",
            },
          })
    ...
    function () {
      if (
        ...
        return React__default.createElement(
          ...
          React__default.createElement(icons.RotateLeftOutlined, null)
        );
      } else {
        return null;
      }
...
var replaceLocale = function replaceLocale(
  ...
  if (config.i18n) {
    ...
    // console.log('====================================');
    if (paramString) {
      return React__default.createElement(reactIntl.FormattedMessage, {
        id: id,
...
var DragHandle = /*#__PURE__*/ reactSortableHoc.SortableHandle(function () {
  return React__default.createElement(icons.MenuOutlined, null);
});
var leftWidth = 200;
var WAIT = false;
...
var SortableItem = /*#__PURE__*/ reactSortableHoc.SortableElement(function (
  _ref
) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(DragHandle, null)
      ),
      React__default.createElement(
        "div",
        null,
      ...
      React__default.createElement("div", null, value.value.id.slice(-6)),
      React__default.createElement(
        "div",
        {
          style: {
        ...
        React__default.createElement(
          ...
          value.value.canSee
            ? React__default.createElement(icons.EyeOutlined, null)
            : React__default.createElement(icons.EyeInvisibleOutlined, null)
        ),
        React__default.createElement(
          _Popconfirm,
          {
...
var SortableList = /*#__PURE__*/ reactSortableHoc.SortableContainer(function (
  _ref2
) {
  ...
  return React__default.createElement(
    ...
    items.data.map(function (value, index) {
      return (
        // @ts-ignore
        React__default.createElement(SortableItem, {
          key: value.id,
          index: index,
          value: {
            value: value,
...
function TimeLine(props) {
  ...
  var _useState3 = React.useState(initialLeft),
    needle = _useState3[0],
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.createElement(
                ...
                React__default.createElement(icons.PauseCircleOutlined, {
                  onClick: function onClick() {
                    needlePause();
                  },
                })
              ...
              React__default.createElement(
                ...
                React__default.createElement(icons.PlayCircleOutlined, null)
              )
            )
          ),
          content
          ...
          React__default.createElement(
            ...
            renderData.map(function (v) {
              return React__default.createElement(
                ...
                React__default.createElement(TimeLineItem, {
                  animate: v.animate,
                }),
                animateTicker.map(function (v) {
                  if (v % 10 === 0) {
    ...
    function () {
      return React__default.createElement(
        ...
        lines.x.map(function (v, i) {
          return React__default.createElement(MarklineX, {
            key: i,
            top: v,
          });
        }),
        lines.y.map(function (v, i) {
          return React__default.createElement(MarklineY, {
            key: i,
            left: v,
          });
        })
...
function Blocks(props) {
  ...
  var ref = React.useRef(null);
  var innerDragData = React.useMemo(
    function () {
    ...
    function () {
      ...
      if (state && props.context === "edit") {
        ...
        return React__default.createElement(
          ...
          React__default.createElement(BlockResizer, {
            data: props.data,
            config: props.config,
            rect: ref,
          }),
          React__default.createElement(RotateResizer, {
            data: props.data,
            config: props.config,
            rect: ref,
          }),
          React__default.createElement(RotateReset, {
            data: props.data,
            config: props.config,
            rect: ref,
          })
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              props.context === "edit" &&
                React__default.createElement(NormalMarkLineRender, {
                  config: props.config,
                  iframe: false,
                }),
              props.state.block.map(function (v) {
                return React__default.createElement(Blocks, {
                  config: props.config,
                  key: v.id,
                  data: v,
...
function LeftConfig(props) {
  ...
  var leftMapRenderListCategory = React.useMemo(
    function () {
  ...
  var _useState5 = React.useState(props.config.getCollapse()),
    isCollapse = _useState5[0],
    setCollapse = _useState5[1];

  var _useState6 = React.useState(props.config.getCollapse()),
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(_Menu.Item, {
          ...
          icon: isCollapse
            ? React__default.createElement(icons.DoubleRightOutlined, null)
            : React__default.createElement(icons.DoubleLeftOutlined, null),
        })
      )
    ),
    React__default.createElement(
...
function Preview(props) {
  ...
  if (isEdit) {
    ...
    var loadingNode = React__default.createElement(
      "div",
      null,
...
function ColorPicker(props) {
  var _useState = React.useState(props.initColor),
    color = _useState[0],
...
var ColorPicker$1 = /*#__PURE__*/ React.memo(ColorPicker);
...
function RightConfig(props) {
  ...
  var rightMapRenderListCategory = React.useMemo(
    function () {
  ...
  var initTitle = React.useMemo(
    function () {
      return props.config.getStore().getData().globalState.title;
    },
    [props.config]
  );
  var initDescription = React.useMemo(
    function () {
  ...
  var _useState3 = React.useState(initTitle),
    title = _useState3[0],
    setTitle = _useState3[1];

  var _useState4 = React.useState(initDescription),
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(_InputNumber, {
              min: 0,
              disabled: true,
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(ColorPicker$1, {
              initColor: initColor,
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(_Switch, {
...
function ContainerWrapper(props) {
  ...
  return React__default.createElement(
    ...
    children,
    ticker &&
      React__default.createElement(Ticker, {
        config: props.config,
      })
  );
}
...
var SettingsModal$1 = /*#__PURE__*/ React.memo(SettingsModal);
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(_Button, {
        ...
        icon: React__default.createElement(icons.UnorderedListOutlined, null),
      }),
      React__default.createElement(_Button, {
        icon: React__default.createElement(icons.LayoutOutlined, null),
        onClick: function onClick() {
      ...
      React__default.createElement(_Button, {
        icon: React__default.createElement(icons.SyncOutlined, null),
        onClick: function onClick() {
      ...
      React__default.createElement(_Button, {
        icon: React__default.createElement(icons.SettingOutlined, null),
        onClick: function onClick() {
    ...
    React__default.createElement(SettingsModal$1, {
      config: props.config,
...
function LeftDataPannel(props) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      _Row,
      null,
      React__default.createElement(_Table, {
        pagination: false,
        style: {
          width: "100%",
        },
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.createElement(_Input.TextArea, null)
            )
          )
        )
      ),
...
var createModal = function createModal(name, data, config) {
  ...
  ReactDOM.render(
    React__default.createElement(ModalRender, {
      name: name,
      data: data,
      config: config,
      parentDom: divs,
    ...
    return React__default.createElement(
      ...
      context === "edit" &&
        React__default.createElement(_Button, {
          ...
          icon: React__default.createElement(icons.SaveOutlined, null),
          onClick: function onClick() {
...
var defaultConfig = {
  ...
  initCommandModule: [],
  initFormComponents: {},
  containerIcon: /*#__PURE__*/ React__default.createElement(
...
function ContainerWrapper$1(props) {
  ...
  return React__default.createElement(
    ...
    extra && extra,
    ticker &&
      React__default.createElement(Ticker$1, {
        config: props.config,
      })
  );
}
...
exports.IframeContainer = Container$1;
exports.IframeContainerWrapper = ContainerWrapper$1;
exports.IframeTarget = IframeTarget;
exports.LeftConfig = LeftConfig;
exports.LeftDataPannel = LeftDataPannel;
exports.Preview = Preview;
exports.RightConfig = RightConfig;
exports.UserConfig = UserConfig;
exports.arrayMove = arrayMove;
exports.changeUserValue = changeUserValue;
exports.changeUserValueRecord = changeUserValueRecord;
exports.createPannelOptions = createPannelOptions;
exports.createUid = createUid;
exports.deepCopy = deepCopy;
exports.defaultStore = defaultStore;
exports.dragEventResolve = dragEventResolve;
exports.focusState = focusState;
exports.innerContainerDragUp = innerContainerDragUp;
exports.locale = index;
exports.postMessage = postMessage;
exports.rgba2Obj = rgba2Obj;
exports.scaleFn = scaleFn;
exports.specialCoList = specialCoList;
exports.specialFnList = specialFnList;
exports.swap = swap;
exports.unmountContextMenu = unmountContextMenu;
exports.useDynamicAddEventCenter = useDynamicAddEventCenter;
exports.useIframeHook = useIframeHook;
exports.useIframePostMessage = useIframePostMessage;
exports.useRegistFunc = useRegistFunc;
exports.useStoreState = useStoreState;
exports.userConfigMerge = userConfigMerge;
//# sourceMappingURL=lowcode-lib.cjs.development.js.map
